...
const AdminJobManagement = () => {
  ...
  const addSkill = () => {
    if (skillsInput.trim() && !formData.skillsRequired.includes(skillsInput.trim())) {
      setFormData(prev => ({
        ...prev,
                ...
                <div className="ml-5 w-0 flex-1">
                  <dl>
                    ...
                    <dd className="text-lg font-medium text-gray-900">
                      {jobs.filter(job => job.isActive !== false && job.is_active !== false).length}
                    </dd>
                  </dl>
                </div>
              </div>
        ...
        <div className="bg-white shadow overflow-hidden sm:rounded-md">
          <div className="px-4 py-5 sm:px-6">
            ...
            <p className="mt-1 max-w-2xl text-sm text-gray-500">
              Manage job postings, edit details, and track applications
            </p>
          </div>
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex-1">
                      ...
                      <div className="flex items-center space-x-6 mb-2">
                        ...
                        <span className="text-sm text-gray-500">
                          {formatSalary(job.salaryMin || job.salary_min, job.salaryMax || job.salary_max, job.currency)}
                        </span>
                      </div>
                      ...
                      <div className="flex flex-wrap gap-1 mb-2">
                        ...
                        {(job.skillsRequired || job.skills_required || []).length > 3 && (
                          <span className="text-xs text-gray-500">
                            +{(job.skillsRequired || job.skills_required || []).length - 3} more
                          </span>
                        )}
                      </div>
